...
namespace CodeSparkNET.Infrastructure.Repositories.Catalogs
{
    /// <summary>
    ...
    public class CatalogRepository : ICatalogRepository
    {
        ...
        /// </remarks>
        /// <returns>
        /// A <see cref="List{Catalog}"/> containing all catalogs. If an error occurs, returns an empty list.
        /// </returns>
        /// <exception cref="Exception">All exceptions are logged and swallowed; they are not rethrown by this method.</exception>
