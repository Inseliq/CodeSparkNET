const DOCS_CONFIG = {
        ...
        <div class="docs-welcome__card">
          <div class="docs-welcome__card-inner">
            <p class="docs-welcome__hint" style="margin-bottom: 0;">
              Выберите раздел документации в меню
            </p>
          </div>
        </div>
      </div>
  ...
  'privacy-policy': {
    ...
    content: `
      ...
      <h2>7. Контакты</h2>
      <p>По вопросам конфиденциальности обращайтесь: <a href="mailto:codespark@io.com">codespark@io.com</a></p>
    `
  },
  'user-guide': {
    ...
    content: `
      ...
      <ul>
        ...
        <li>Нажмите на ссылку <b>зарегистрироваться</b></li>
